...
import 'package:campusmate_server/src/generated/protocol.dart' as _i7;

abstract class AcademicOverview
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      '__className__': 'AcademicOverview',
      'currentSemester': currentSemester.toJsonForProtocol(),
      'availableSemesters': availableSemesters.toJson(
        valueToJson: (v) => v.toJsonForProtocol(),
      ),
      'courses': courses.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      'today': today.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      'upcomingExams': upcomingExams.toJson(
        valueToJson: (v) => v.toJsonForProtocol(),
      ),
