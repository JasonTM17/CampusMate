...
- **Verification budget**: Focused checks during repair; broad gates only at named checkpoints.
- **Repair ceiling**: Two focused attempts plus at most one specialist-guided attempt.
- **Deferred queue**: Record unrelated findings without widening this fix.
