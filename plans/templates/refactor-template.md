...
- **Verification budget**: Characterization and broad comparison stay at named checkpoints.
- **Repair ceiling**: Two focused attempts plus at most one specialist-guided attempt.
- **Deferred queue**: Record unrelated cleanup without widening this refactor.
